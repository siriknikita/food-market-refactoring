...
from market.models import Categories, OrderDetails, PetProducts

pet_products = Blueprint('pet_products', __name__)


@pet_products.route('/pet_products', methods=['GET', 'POST'])
@login_required
