...
from market.models import BabyProducts, Categories, OrderDetails

baby_products = Blueprint('baby_products', __name__)


@baby_products.route('/baby_products', methods=['GET', 'POST'])
@login_required
